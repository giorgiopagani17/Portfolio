...
// Asynchronous loading of FontAwesome
const loadIcons = () => {
  return import('@fortawesome/react-fontawesome')
    .then(module => {
      const { FontAwesomeIcon } = module;
      ...
      <div className="flex items-center justify-center custom-min-height gap-x-[10%] mt-[-2%]" itemProp="mainContentOfPage">
        <Card color="transparent" shadow={false} className="slide-in-left">
          <CardBody className="mb-6 pl-5 text-white md:text-center">
            ...
            <p className="mt-10 text-base md:text-xl lg:text-2xl">Sono un junior full-stack developer specializzato in React e Python</p>
            <div className="mt-10">
              <FontAwesomeIcon
                icon={faInstagram}
                size="2xl"
