...
const Skills = () => {
  ...
  return (
    <div id="skills" itemScope itemType="https://schema.org/Skill">
        <div>
            ...
            <div className="text-center text-black text-6xl mt-10">
            ...
            <div className="flex justify-center mt-5">
                <Card className="mt-10" style={{ transform: 'scale(0.95)', transformOrigin: 'top' }} data-aos="fade-right">
                    <CardBody>
                    <div className="flex justify-center mt-1 mb-6 space-x-10">
                    <strong
            ...
            <div className="flex flex-col justify-center items-center mt-5 mb-10 text-center" data-aos="fade-left">
                ...
                <h2 className="text-white">Ecco i linguaggi di programmazione e <br/> i tools che conosco</h2>
            </div>
        </div>
    </div>
  );
