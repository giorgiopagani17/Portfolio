...
// Utilizzo dell'icona con animazione "bounce"
<FontAwesomeIcon icon={faPaperPlane} className="bounce" />
            ...
            <div className="flex items-center justify-center min-h-screen gap-x-80" style={{ marginTop: '-8vh' }}>
                ...
                <div className="mb-6 pl-5 w-96">
                    <form className="max-w-sm mx-auto">
                        <label for="email-address-icon" className="mt-5 block mb-2 text-base font-medium text-gray-900 dark:text-white">Email</label>
                        ...
                        <label for="email-address-icon" className="mt-5 block mb-2 text-base font-medium text-gray-900 dark:text-white">Nome e Cognome</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                            ...
                            <input type="text" id="email-address-icon" className="bg-gray-50 border border-blue-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Mario Rossi"/>
                        </div>

                        <label for="email-address-icon" className="mt-5 block mb-2 text-base font-medium text-gray-900 dark:text-white">Oggetto</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                            ...
                            <input type="text" id="email-address-icon" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Collaborazione"/>
                        </div>
                        
                        <label for="message" className="mt-5 block mb-2 text-base font-medium text-gray-900 dark:text-white">Messaggio</label>
                        <textarea id="message" rows="4" className="block p-2.5 w-full text-base text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ciao Giorgio, vorrei collaborare con te..."></textarea>
                        <button 
                            type="button" 
                        ...
                        >
                            Invia Messaggio
                            {isConfirmHovered ? (
                                <FontAwesomeIcon className="ml-2" icon={faPaperPlane} bounce />
                            ) : (
