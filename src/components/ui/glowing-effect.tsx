...
interface GlowingEffectProps {
    ...
    proximity?: number;
    spread?: number;
    variant?: "default" | "white" | "section-header";
    glow?: boolean;
    className?: string;
    disabled?: boolean;
...
const GlowingEffect = memo(
    ({
        ...
        } else if (variant === "section-header") {
            // Match the section header gradient colors (blue-600 to purple-600)
            gradientValue = `radial-gradient(circle, #3b82f6 10%, #3b82f600 20%),
